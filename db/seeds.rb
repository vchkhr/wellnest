...
[technique1, technique2, technique3, technique4].each do |technique|
  technique.steps << Step.create!(title: '1 What is cognitive behavior therapy?', description: 'Cognitive behavioral therapy (CBT) is a type of psychotherapy. This form of therapy modifies thought patterns in order to change moods and behaviors. It\'s based on the idea that negative actions or feelings are the result of current distorted beliefs or thoughts, not unconscious forces from the past.<br>CBT is a blend of cognitive therapy and behavioral therapy. Cognitive therapy focuses on your moods and thoughts. Behavioral therapy specifically targets actions and behaviors. A therapist practicing the combined approach of CBT works with you in a to identify specific negative thought patterns and behavioral responses to challenging or stressful situations.<br>Treatment involves developing more balanced and constructive ways to respond to stressors. Ideally these new responses will help minimize or eliminate the troubling behavior or disorder.<br>The principles of CBT can also be applied outside of the therapist\'s office. Online cognitive behavioral therapy is one example. It uses the principles of CBT to help you track and manage your depression and anxiety symptoms online.')
  technique.steps << Step.create!(title: '2 What should you do?', description: 'Look at this picture and do something. And when you do something, don\'t forget to do something.', image: 'https://domf5oio6qrcr.cloudfront.net/medialibrary/7813/a83db567-4c93-4ad0-af6f-72b57af7675d.jpg')
  technique.steps << Step.create!(title: '3 What should you do?', description: 'Look at this picture and do something. And when you do something, don\'t forget to do something.', video: 'https://player.vimeo.com/external/415158674.sd.mp4?s=a05be1360154cec9520a51ed5750496b52419205&profile_id=139&oauth2_token_id=57447761')
  technique.steps << Step.create!(title: '4 What should you do?', description: 'Look at this picture and do something. And when you do something, don\'t forget to do something.', audio: 'https://www.uclahealth.org/marc/mpeg/01_Breathing_Meditation.mp3')
