...
user3 = User.create!(name: 'Jessica Aldridge', email: 'jessica@aldridge.com', password: 'abc12345', age: 23, problems: [Problem.find_by_name('Depression')])
user3.gender = 'female'

coach1 = Coach.create!(name: 'James Brown', email: 'james@brown.com', password: 'abc12345', age: 36, education: 'New York University, PhD in Psychology', work: 'Psychologist, ABC company, 12 years', licenses: 'New York / 081109, New York University, 2009', links: 'http://example.org', problems: [Problem.find_by_name('Anxiety'), Problem.find_by_name('Depression')])
coach1.gender = 'male'

coach2 = Coach.create!(name: 'Amelia Adamson', email: 'amelia@adamson.com', password: 'abc12345', age: 25, education: 'education', work: 'work', licenses: 'licenses', links: 'http://example.org', problems: [Problem.find_by_name('Anxiety'), Problem.find_by_name('Depression')])
coach2.gender = 'female'

coach3 = Coach.create!(name: 'Gabriel Wilson', email: 'gabriel@wilson.com', password: 'abc12345', age: 32, education: 'education', work: 'work', licenses: 'licenses', links: 'http://example.org', problems: [Problem.find_by_name('Depression')])
coach3.gender = 'female'

coach4 = Coach.create!(name: 'Leo Ellington', email: 'leo@ellington.com', password: 'abc12345', age: 31, education: 'education', work: 'work', licenses: 'licenses', links: 'http://example.org', problems: [Problem.find_by_name('Anxiety'), Problem.find_by_name('Depression')])
coach4.gender = 'male'

coach5 = Coach.create!(name: 'Tom Young', email: 'tom@young.com', password: 'abc12345', age: 32, education: 'education', work: 'work', licenses: 'licenses', links: 'http://example.org', problems: [Problem.find_by_name('Depression')])
coach5.gender = 'male'

coach6 = Coach.create!(name: 'Scarlett Davies', email: 'scarlett@davies.com', password: 'abc12345', age: 31, education: 'education', work: 'work', licenses: 'licenses', links: 'http://example.org', problems: [Problem.find_by_name('Anxiety'), Problem.find_by_name('Depression')])
coach6.gender = 'female'
