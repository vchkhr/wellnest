...
client_1 = User.create!(name: 'Ann Albertson', email: 'ann@albertson.com', password: 'abc12345', age: 30, gender: Gender.find_by_name('Female'), problems: [Problem.find_by_name('Depression'), Problem.find_by_name('Irritability'), Problem.find_by_name('Stress')])
