...
class InvitationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create invitation" do
    assert_difference('Invitation.count') do
      post invitations_url, params: { invitation: { client_id: @invitation.client_id, coach_id: @invitation.coach_id, status: @invitation.status } }
    end
  ...
  test "should update invitation" do
    patch invitation_url(@invitation), params: { invitation: { client_id: @invitation.client_id, coach_id: @invitation.coach_id, status: @invitation.status } }
