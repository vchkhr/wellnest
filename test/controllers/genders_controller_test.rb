...
class GendersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gender" do
    assert_difference('Gender.count') do
      post genders_url, params: { gender: { client: @gender.client, coach: @gender.coach, name: @gender.name } }
    end
  ...
  test "should update gender" do
    patch gender_url(@gender), params: { gender: { client: @gender.client, coach: @gender.coach, name: @gender.name } }
