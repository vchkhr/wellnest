...
class TechniquesCompletedTest < ActiveSupport::TestCase
  test "should return completed techniques for client" do
    ...
    CompletedStep.create!(step: technique1.steps[2], client: client1)
    CompletedStep.create!(step: technique1.steps[3], client: client1)

    assert_equal [technique1], ClientManager::TechniquesCompleted.call(client1)
  end
end
